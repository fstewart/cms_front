class EventCategoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @event_category.save
        format.html { redirect_to event_categories_url, notice: 'Event category was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @event_category.update(event_category_params)
        format.html { redirect_to event_categories_url, notice: 'Event category was successfully updated.' }
  ...
  def resolve_layout
    ...
    def event_category_params
      params.require(:event_category).permit(:name, :status)
    end
end
