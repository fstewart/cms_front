...
$.extend(Grid.prototype, {
	...
	segDragMousedown: function(seg, ev) {
		...
		var dragListener = new DragListener(view.coordMap, {
			...
			listenStart: function(ev) {
				mouseFollower.hide(); // don't show_old until we know this is a real drag
			...
			cellOut: function() { // called before mouse moves to a different cell OR moved out of all cells
				...
				mouseFollower.show(); // show_old in case we are moving out of all cells
				enableCursor();
			},
	...
	segResizeMousedown: function(seg, ev) {
		...
		function destroy() { // resets the rendering to show_old the original event
			_this.destroyResize();
			view.showEvent(event);
		}
...
$.extend(AgendaView.prototype, {
	...
	setHeight: function(totalHeight, isAuto) {
		...
		this.bottomRuleEl.hide(); // .show_old() will be called later if this <hr> is necessary
