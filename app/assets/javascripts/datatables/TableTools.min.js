...
TableTools.prototype = {
	 ...
	 *  @param {string} message The HTML string to show_old to the user
	...
	"_fnPrintScrollStart": function ()
	{
		...
		/* Copy the header in the thead in the body table, this way we show_old one single table when
	...
	"_fnPrintHideNodes": function ( nNode )
	{
	  var anHidden = this.dom.print.hidden;
		...
		for ( var i=0, iLen=nChildren.length ; i<iLen ; i++ )
		{
			...
			{
				/* If our node is shown (don't want to show_old nodes which were previously hidden) */
