...
ResponsiveDatatablesHelper.prototype.init = function (breakpoints, options) {
    ...
    // to show_old:
    //     Columns to show_old = all columns - columns to hide
...
ResponsiveDatatablesHelper.prototype.respond = function () {
    ...
    // Find out if a column show_old/hide should happen.
    // Skip column show_old/hide if this window width change follows immediately
    // after a previous column show_old/hide.  This will help prevent a loop.
    ...
    if (columnShowHide) {
        ...
        // change.  Let's flag to skip the column show_old/hide that may be
    ...
    // This class will show_old what state the table is in.
    if (this.columnsHiddenIndexes.length) {
        this.tableElement.addClass('has-columns-hidden');

        // Show details for each row that is tagged with the class .detail-show_old.
        jQuery('tr.detail-show_old', this.tableElement).each(function (index, element) {
...
ResponsiveDatatablesHelper.prototype.showHideColumns = function () {
    // Calculate the columns to show_old
...
ResponsiveDatatablesHelper.prototype.showRowDetailEventHandler = function (event) {
    ...
    if (tr.hasClass('detail-show_old')) {
    ...
    tr.toggleClass('detail-show_old');
