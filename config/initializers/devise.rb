...
Devise.setup do |config|
  ...
  config.ldap_auth_username_builder = Proc.new() {|attribute, login, ldap| "CBA\\#{login}"}
...
#  end
  ...
  config.secret_key = 'de9e7b7f4610f2499e1323e9b65642664ab9f66e5a72a9132308d6da62e881f9c8cf497185134e16223a47425a3aa10ce79675f2cbb90fff547a6765da45788f'
  ...
  # config.pepper = '65561354348a859e1e57663ffd996046dbf8c522e0645dfdc16e0a1625a22b2d07524e1e79ff34aff539ef46e8b2ad5e90542c226a563c50a22a11aeeef2dd7e'
  ...
  config.cas_base_url = "https://login.ua.edu/cas/"

  # you can override these if you need to, but cas_base_url is usually enough
  config.cas_login_url = "https://login.ua.edu/cas/login?service=http://culverhouse.ua.edu/manderson-launch"
  #config.cas_logout_url = ""
  config.cas_validate_url = "https://login.ua.edu/cas/login?service=http://culverhouse.ua.edu/manderson-launch/"
  ...
  config.cas_destination_url = 'http://webdev.cba.ua.edu/launch/directory'
  ...
  config.cas_destination_logout_param_name = 'http://webdev.cba.ua.edu/launch'
